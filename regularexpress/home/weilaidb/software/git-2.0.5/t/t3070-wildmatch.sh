...
match 1 1 'foo/baz/bar' 'foobar'
match 1 0 'foo/baz/bar' 'foo**/bar'
match 1 0 'foo/b/a/z/bar' 'foobar'
match 1 0 'foo/b/a/z/bar' 'foo**/bar'
match 1 0 'foo/bar' 'foobar'
...
match 1 0 'deep/foo/bar/baz' '**/barbarbarbarbarbar**'
match 1 0 'foo/bar/baz/x' '*/barbarbar\'
match 1 x 'XXX/\' '*/\\'
match 1 1 'foo' 'foo'
match 1 1 '@foo' '@foo'
match 0 0 'foo' '@foo'
...
match 1 1 'XXX/adobe/courier/bold/o/normal
match 0 0 'XXX/adobe/courier/bold/o/normal
match 1 0 'abcd/abcdefg/abcdefghijk/abcdefghijklmnop.txt' '***a*b*g*n*t'
match 0 x foo '*******X**X**i'
pathmatch 1 foo foo
pathmatch 0 foo fo
pathmatch 1 foo/bar foo/bar
pathmatch 1 foo/bar 'foo*****X*/*/*i'
