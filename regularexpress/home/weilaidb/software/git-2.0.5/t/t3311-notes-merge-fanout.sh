...
'
commit_sha1=$(git rev-parse commit1^)
commit_sha2=$(git rev-parse commit2^)
commit_sha3=$(git rev-parse commit3^)
commit_sha4=$(git rev-parse commit4^)
commit_sha5=$(git rev-parse commit5^)
