...
test_commit 15th
'
commit_sha1=$(git rev-parse 1st^)
commit_sha2=$(git rev-parse 2nd^)
commit_sha3=$(git rev-parse 3rd^)
commit_sha4=$(git rev-parse 4th^)
commit_sha5=$(git rev-parse 5th^)
commit_sha6=$(git rev-parse 6th^)
commit_sha7=$(git rev-parse 7th^)
commit_sha8=$(git rev-parse 8th^)
commit_sha9=$(git rev-parse 9th^)
commit_sha10=$(git rev-parse 10th^)
commit_sha11=$(git rev-parse 11th^)
commit_sha12=$(git rev-parse 12th^)
commit_sha13=$(git rev-parse 13th^)
commit_sha14=$(git rev-parse 14th^)
commit_sha15=$(git rev-parse 15th^)
verify_notes ()
