...
Window_OneArgNoReturnVoidFunction(idcok, int, )
Window_OneArgNoReturnVoidFunction(immedok, int, )
Window_OneArgNoReturnVoidFunction(wtimeout, int, )
Window_NoArg2TupleReturnFunction(getyx, int, )
Window_NoArg2TupleReturnFunction(getbegyx, int, )
Window_NoArg2TupleReturnFunction(getmaxyx, int, )
Window_NoArg2TupleReturnFunction(getparyx, int, )
Window_OneArgNoReturnFunction(clearok, int, )
Window_OneArgNoReturnFunction(idlok, int, )
#if defined(__NetBSD__)
Window_OneArgNoReturnVoidFunction(keypad, int, )
Window_OneArgNoReturnFunction(keypad, int, )
Window_OneArgNoReturnFunction(leaveok, int, )
#if defined(__NetBSD__)
Window_OneArgNoReturnVoidFunction(nodelay, int, )
Window_OneArgNoReturnFunction(nodelay, int, )
Window_OneArgNoReturnFunction(notimeout, int, )
Window_OneArgNoReturnFunction(scrollok, int, )
Window_OneArgNoReturnFunction(winsdelln, int, )
Window_OneArgNoReturnFunction(syncok, int, )
Window_TwoArgNoReturnFunction(mvwin, int, )
Window_TwoArgNoReturnFunction(mvderwin, int, )
Window_TwoArgNoReturnFunction(wmove, int, )
Window_TwoArgNoReturnFunction(wresize, int, )
static PyObject *
