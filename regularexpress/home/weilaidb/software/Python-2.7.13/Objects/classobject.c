...
UNARY(instance_pos, )
UNARY(instance_abs, )
BINARY(instance_or, , PyNumber_Or)
BINARY(instance_and, , PyNumber_And)
BINARY(instance_xor, , PyNumber_Xor)
BINARY(instance_lshift, , PyNumber_Lshift)
BINARY(instance_rshift, , PyNumber_Rshift)
BINARY(instance_add, , PyNumber_Add)
BINARY(instance_sub, , PyNumber_Subtract)
BINARY(instance_mul, , PyNumber_Multiply)
BINARY(instance_div, , PyNumber_Divide)
BINARY(instance_mod, , PyNumber_Remainder)
BINARY(instance_divmod, , PyNumber_Divmod)
BINARY(instance_floordiv, , PyNumber_FloorDivide)
BINARY(instance_truediv, , PyNumber_TrueDivide)
BINARY_INPLACE(instance_ior, , PyNumber_InPlaceOr)
BINARY_INPLACE(instance_ixor, , PyNumber_InPlaceXor)
BINARY_INPLACE(instance_iand, , PyNumber_InPlaceAnd)
BINARY_INPLACE(instance_ilshift, , PyNumber_InPlaceLshift)
BINARY_INPLACE(instance_irshift, , PyNumber_InPlaceRshift)
BINARY_INPLACE(instance_iadd, , PyNumber_InPlaceAdd)
BINARY_INPLACE(instance_isub, , PyNumber_InPlaceSubtract)
BINARY_INPLACE(instance_imul, , PyNumber_InPlaceMultiply)
BINARY_INPLACE(instance_idiv, , PyNumber_InPlaceDivide)
BINARY_INPLACE(instance_imod, , PyNumber_InPlaceRemainder)
BINARY_INPLACE(instance_ifloordiv, , PyNumber_InPlaceFloorDivide)
BINARY_INPLACE(instance_itruediv, , PyNumber_InPlaceTrueDivide)
static int
...
UNARY(instance_invert, )
UNARY(_instance_trunc, )
static PyObject *
instance_int(PyInstanceObject *self)
UNARY_FB(instance_long, , instance_int)
UNARY(instance_float, )
UNARY(instance_oct, )
UNARY(instance_hex, )
static PyObject *
