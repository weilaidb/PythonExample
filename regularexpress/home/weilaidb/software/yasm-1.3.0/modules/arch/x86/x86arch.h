...
PARSER (((arch)->parser == X86_PARSER_GAS && (arch)->gas_intel_mode) ? X86_PARSER_NASM : (arch)->parser)
...
yasm_x86__ea_print;
yasm_x86__bc_insn_opersize_override;
yasm_x86__bc_insn_addrsize_override;
yasm_x86__bc_insn_set_lockrep_prefix;
