...
#define INFO(x)
#define ERR(x)
#define DEB_S(x)    if (0!=(DEBUG_VARIABLE&0x01))
#define DEB_D(x)    if (0!=(DEBUG_VARIABLE&0x02))
#define DEB_EE(x)   if (0!=(DEBUG_VARIABLE&0x04))
#define DEB_I2C(x)  if (0!=(DEBUG_VARIABLE&0x08))
#define DEB_VBI(x)  if (0!=(DEBUG_VARIABLE&0x10))
#define DEB_INT(x)  if (0!=(DEBUG_VARIABLE&0x20))
#define DEB_CAP(x)  if (0!=(DEBUG_VARIABLE&0x40))
