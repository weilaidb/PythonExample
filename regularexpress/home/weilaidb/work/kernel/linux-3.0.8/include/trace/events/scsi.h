...
#define scsi_opcode_name(opcode)
...
#define scsi_hostbyte_name(result)
...
#define scsi_driverbyte_name(result)
...
#define scsi_msgbyte_name(result)
...
#define scsi_statusbyte_name(result)
...
#define scsi_prot_op_name(result)
