...
#define __get_PDR()	()
#define __set_PDR(V)	do  while(0)
#define __get_GPDR()	()
#define __set_GPDR(V)	do  while(0)
#define __get_SIR()	()
#define __set_SIR(V)	do  while(0)
#define __get_SOR()	()
#define __set_SOR(V)	do  while(0)
#define __set_PDSR(V)	do  while(0)
#define __set_PDCR(V)	do  while(0)
#define __get_RSTR()	()
#define __set_RSTR(V)	do  while(0)
