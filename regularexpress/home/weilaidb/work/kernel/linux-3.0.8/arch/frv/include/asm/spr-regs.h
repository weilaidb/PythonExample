...
#define __get_HSR(R)	()
#define __set_HSR(R,V)	do  while(0)
...
#define __get_IAMPR(R) ()
#define __get_DAMPR(R) ()
#define __get_IAMLR(R) ()
#define __get_DAMLR(R) ()
#define __set_IAMPR(R,V) 	do  while(0)
#define __set_DAMPR(R,V)  	do  while(0)
#define __set_IAMLR(R,V) 	do  while(0)
#define __set_DAMLR(R,V)  	do  while(0)
