...
#define MPP(_num, _sel, _in, _out, _F6180, _F6190, _F6192, _F6281, _F6282) ( \		((_num) & 0xff) | \		(((_sel) & 0xf) << 8) | \	((!!(_in)) << 12) | \	((!!(_out)) << 13) | \	((!!(_F6180)) << 14) | \	((!!(_F6190)) << 15) | \	((!!(_F6192)) << 16) | \	((!!(_F6281)) << 17) | \	((!!(_F6282)) << 18))
