...
#define AT91_EBI	(0xffe00000 - AT91_BASE_SYS)
#define AT91_SF		(0xfff00000 - AT91_BASE_SYS)
#define AT91_USART1	(0xfffcc000 - AT91_BASE_SYS)
#define AT91_USART0	(0xfffd0000 - AT91_BASE_SYS)
#define AT91_TC		(0xfffe0000 - AT91_BASE_SYS)
#define AT91_PIOA	(0xffff0000 - AT91_BASE_SYS)
#define AT91_PS		(0xffff4000 - AT91_BASE_SYS)
#define AT91_WD		(0xffff8000 - AT91_BASE_SYS)
