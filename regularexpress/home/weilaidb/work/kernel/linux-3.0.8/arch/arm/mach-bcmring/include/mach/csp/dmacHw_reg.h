...
typedef struct  dmacHw_REG64_t;
typedef struct  dmacHw_CH_REG_t;
typedef struct  dmacHw_INT_RAW_t;
typedef struct  dmacHw_INT_STATUS_t;
typedef struct  dmacHw_INT_MASK_t;
typedef struct  dmacHw_INT_CLEAR_t;
typedef struct  dmacHw_SW_HANDSHAKE_t;
typedef struct  dmacHw_MISC_t;
