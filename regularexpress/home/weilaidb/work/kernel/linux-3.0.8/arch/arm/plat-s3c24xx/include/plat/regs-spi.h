...
#define S3C2412_SPCON_RXFIFO_RESET	(1<<11)
#define S3C2412_SPCON_TXFIFO_RESET	(1<<10)
#define S3C2412_SPCON_RXFIFO_EN		(1<<9)
#define S3C2412_SPCON_TXFIFO_EN		(1<<8)
