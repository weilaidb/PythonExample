#define DDRC_REG_H
typedef struct  ddrcReg_CTLR_MEMC_REG_t;
...
typedef struct  ddrcReg_CTLR_QOS_REG_t;
...
typedef struct  ddrcReg_CTLR_CHIP_REG_t;
...
typedef struct  ddrcReg_CTLR_USER_REG_t;
...
typedef struct  ddrcReg_PHY_ADDR_CTL_REG_t;
...
typedef struct  ddrcReg_PHY_BYTE_LANE_REG_t;
...
typedef struct  ddrcReg_CTLR_PHY_GLUE_REG_t;
