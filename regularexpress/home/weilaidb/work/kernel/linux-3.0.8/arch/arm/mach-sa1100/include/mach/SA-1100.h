...
#define DMASp   	0x00000020
#define DDAR(Nb)	__REG(0xB0000000 + (Nb)*DMASp)
#define SetDCSR(Nb)	__REG(0xB0000004 + (Nb)*DMASp)
#define ClrDCSR(Nb)	__REG(0xB0000008 + (Nb)*DMASp)
#define RdDCSR(Nb)	__REG(0xB000000C + (Nb)*DMASp)
#define DBSA(Nb)	__REG(0xB0000010 + (Nb)*DMASp)
#define DBTA(Nb)	__REG(0xB0000014 + (Nb)*DMASp)
#define DBSB(Nb)	__REG(0xB0000018 + (Nb)*DMASp)
#define DBTB(Nb)	__REG(0xB000001C + (Nb)*DMASp)
#define DDAR_RW 	0x00000001
#define DDAR_DevWr	(DDAR_RW*0)
#define DDAR_DevRd	(DDAR_RW*1)
#define DDAR_E  	0x00000002
#define DDAR_LtlEnd	(DDAR_E*0)
#define DDAR_BigEnd	(DDAR_E*1)
#define DDAR_BS 	0x00000004
#define DDAR_Brst4	(DDAR_BS*0)
#define DDAR_Brst8	(DDAR_BS*1)
#define DDAR_DW 	0x00000008
#define DDAR_8BitDev	(DDAR_DW*0)
#define DDAR_16BitDev	(DDAR_DW*1)
#define DDAR_DS 	Fld (4, 4)
...
#define DCSR_STRTA	0x00000010
#define DCSR_DONEB	0x00000020
#define DCSR_STRTB	0x00000040
#define DCSR_BIU	0x00000080
#define DCSR_BufA	(DCSR_BIU*0)
#define DCSR_BufB	(DCSR_BIU*1)
#define DBT_TC  	Fld (13, 0)
#define DBTA_TCA	DBT_TC
#define DBTB_TCB	DBT_TC
