...
#define ASSABET_GPIO_CF_IRQ		GPIO_GPIO (21)
#define ASSABET_GPIO_CF_CD		GPIO_GPIO (22)
#define ASSABET_GPIO_CF_BVD2		GPIO_GPIO (24)
#define ASSABET_GPIO_GFX_IRQ		GPIO_GPIO (24)
#define ASSABET_GPIO_CF_BVD1		GPIO_GPIO (25)
