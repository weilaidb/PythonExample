...
typedef struct _drm_i810_ring_buffer  drm_i810_ring_buffer_t;
...
#define I810_WRITE(reg, val)	do  while (0)
#define I810_DEREF16(reg)	(*(__volatile__ u16 *)I810_ADDR(reg))
#define I810_READ16(reg)	I810_DEREF16(reg)
#define I810_WRITE16(reg, val)	do  while (0)
#define I810_VERBOSE 0
#define RING_LOCALS	unsigned int outring, ringmask; \
volatile char *virt;
#define BEGIN_LP_RING(n) do  while (0)
#define ADVANCE_LP_RING() do  while (0)
#define OUT_RING(n) do  while (0)
