...
typedef struct drm_radeon_ring_buffer  drm_radeon_ring_buffer_t;
typedef struct drm_radeon_depth_clear_t  drm_radeon_depth_clear_t;
...
struct drm_buffer;
typedef struct drm_radeon_kcmd_buffer  drm_radeon_kcmd_buffer_t;
...
#define RADEON_WAIT_UNTIL_2D_IDLE() do  while (0)
#define RADEON_WAIT_UNTIL_3D_IDLE() do  while (0)
#define RADEON_WAIT_UNTIL_IDLE() do  while (0)
#define RADEON_WAIT_UNTIL_PAGE_FLIPPED() do  while (0)
#define RADEON_FLUSH_CACHE() do  while (0)
#define RADEON_PURGE_CACHE() do  while (0)
#define RADEON_FLUSH_ZCACHE() do  while (0)
#define RADEON_PURGE_ZCACHE() do  while (0)
#define RING_SPACE_TEST_WITH_RETURN( dev_priv )				\
do  while (0)
#define VB_AGE_TEST_WITH_RETURN( dev_priv )				\
do  while (0)
#define RADEON_DISPATCH_AGE( age ) do  while (0)
#define RADEON_FRAME_AGE( age ) do  while (0)
#define RADEON_CLEAR_AGE( age ) do  while (0)
#define R600_DISPATCH_AGE(age) do  while (0)
#define R600_FRAME_AGE(age) do  while (0)
#define R600_CLEAR_AGE(age) do  while (0)
...
#define OUT_RING_REG( reg, val ) do  while (0)
#define OUT_RING_TABLE( tab, sz ) do  while (0)
#define OUT_RING_DRM_BUFFER(buf, sz) do  while (0)
