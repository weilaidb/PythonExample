...
struct ti_port_status  __attribute__((packed));
...
struct ti_write_data_bytes  __attribute__((packed));
struct ti_read_data_request  __attribute__((packed));
struct ti_read_data_bytes  __attribute__((packed));
struct ti_interrupt  __attribute__((packed));
...
struct ti_firmware_header  __attribute__((packed));
