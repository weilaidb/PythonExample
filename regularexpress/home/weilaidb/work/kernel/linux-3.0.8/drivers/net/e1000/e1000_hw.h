...
typedef enum  e1000_mac_type;
typedef enum  e1000_eeprom_type;
typedef enum  e1000_media_type;
typedef enum  e1000_speed_duplex_type;
typedef enum  e1000_fc_type;
struct e1000_shadow_ram ;
typedef enum  e1000_bus_type;
typedef enum  e1000_bus_speed;
typedef enum  e1000_bus_width;
typedef enum  e1000_cable_length;
typedef enum  e1000_gg_cable_length;
typedef enum  e1000_igp_cable_length;
typedef enum  e1000_10bt_ext_dist_enable;
typedef enum  e1000_rev_polarity;
typedef enum  e1000_downshift;
typedef enum  e1000_smart_speed;
typedef enum  e1000_polarity_reversal;
typedef enum  e1000_auto_x_mode;
typedef enum  e1000_1000t_rx_status;
typedef enum  e1000_phy_type;
typedef enum  e1000_ms_type;
typedef enum  e1000_ffe_config;
typedef enum  e1000_dsp_config;
struct e1000_phy_info ;
struct e1000_phy_stats ;
struct e1000_eeprom_info ;
#define E1000_HOST_IF_MAX_SIZE  2048
typedef enum  e1000_align_type;
