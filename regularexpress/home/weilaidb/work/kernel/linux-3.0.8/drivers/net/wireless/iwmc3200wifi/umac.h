...
struct iwm_udma_in_hdr  __packed;
struct iwm_udma_out_nonwifi_hdr  __packed;
struct iwm_udma_out_wifi_hdr  __packed;
...
struct iwm_rx_ticket  __packed;
struct iwm_rx_mpdu_hdr  __packed;
struct iwm_dev_cmd_hdr  __packed;
struct iwm_umac_fw_cmd_hdr  __packed;
struct iwm_umac_wifi_out_hdr  __packed;
struct iwm_umac_nonwifi_out_hdr  __packed;
struct iwm_umac_wifi_in_hdr  __packed;
struct iwm_umac_nonwifi_in_hdr  __packed;
...
struct iwm_umac_notif_wifi_if  __packed;
...
struct iwm_umac_notif_assoc_start  __packed;
#define UMAC_ASSOC_COMPLETE_SUCCESS		0x0
#define UMAC_ASSOC_COMPLETE_FAILURE		0x1
struct iwm_umac_notif_assoc_complete  __packed;
...
struct iwm_umac_notif_profile_invalidate  __packed;
...
struct iwm_umac_notif_scan_complete  __packed;
...
struct iwm_umac_notif_bss_removed  __packed;
struct iwm_umac_notif_mgt_frame  __packed;
struct iwm_umac_notif_alive  __packed;
struct iwm_umac_notif_init_complete  __packed;
enum ;
struct iwm_fw_error_hdr  __packed;
struct iwm_umac_notif_error  __packed;
...
struct iwm_umac_notif_page_dealloc  __packed;
struct iwm_umac_notif_wifi_status  __packed;
struct iwm_umac_notif_rx_ticket  __packed;
#define UMAC_NTF_RATE_SAMPLE_NR	4
#define UMAC_PHY_NUM_CHAINS     3
#define IWM_UMAC_MGMT_TID	8
#define IWM_UMAC_TID_NR		9
struct iwm_umac_notif_stats  __packed;
#define UMAC_STOP_TX_FLAG    0x1
#define UMAC_RESUME_TX_FLAG  0x2
#define LAST_SEQ_NUM_INVALID     0xFFFF
struct iwm_umac_notif_stop_resume_tx  __packed;
#define UMAC_MAX_NUM_PMKIDS 4
struct iwm_umac_wifi_if  __packed;
