...
typedef struct  DECODE_TREE_NODE;
#define ROOT	0
#define LEAF	0
#define BRANCH	1
typedef struct  McTable;
typedef struct  FragmentStructure;
typedef struct  DataBufferStructure;
typedef struct  Interrupt_Status_Word;
typedef struct BDBlockType  BDBlock;
typedef struct FCBlockType  FCBlock;
typedef struct SBlockType SBlock;
typedef struct ACBlockType  ACBlock;
#define NUM_OF_INTERRUPTS               0x20
typedef struct  ISBlock;
typedef struct  SCLBlock;
typedef struct
SCGBlock;
typedef struct
ISCPBlock;
