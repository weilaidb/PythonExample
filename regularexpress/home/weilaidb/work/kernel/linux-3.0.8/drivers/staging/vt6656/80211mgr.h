...
typedef struct tagWLAN_IE_CCX  WLAN_IE_CCX, *PWLAN_IE_CCX;
typedef struct tagWLAN_IE_CCX_IP  WLAN_IE_CCX_IP, *PWLAN_IE_CCX_IP;
typedef struct tagWLAN_IE_CCX_Ver  WLAN_IE_CCX_Ver, *PWLAN_IE_CCX_Ver;
