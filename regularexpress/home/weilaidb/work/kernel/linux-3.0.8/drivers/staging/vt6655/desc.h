...
typedef struct tagDEVICE_RD_INFO  DEVICE_RD_INFO,   *PDEVICE_RD_INFO;
typedef struct tagRDES0  __attribute__ ((__packed__))
SRDES0, *PSRDES0;
typedef struct tagRDES0  __attribute__ ((__packed__))
SRDES0;
typedef struct tagRDES1  __attribute__ ((__packed__))
SRDES1;
typedef struct tagSRxDesc  __attribute__ ((__packed__))
SRxDesc, *PSRxDesc;
typedef const SRxDesc *PCSRxDesc;
typedef struct tagTDES0  __attribute__ ((__packed__))
STDES0, PSTDES0;
typedef struct tagTDES0  __attribute__ ((__packed__))
STDES0;
typedef struct tagTDES1  __attribute__ ((__packed__))
STDES1;
typedef struct tagDEVICE_TD_INFO DEVICE_TD_INFO,    *PDEVICE_TD_INFO;
typedef struct tagSTxDesc  __attribute__ ((__packed__))
STxDesc, *PSTxDesc;
typedef const STxDesc *PCSTxDesc;
typedef struct tagSTxSyncDesc  __attribute__ ((__packed__))
