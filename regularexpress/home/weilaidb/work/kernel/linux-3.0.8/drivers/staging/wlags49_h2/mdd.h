...
typedef struct name##_STRCT  name##_STRCT;
...
typedef struct KEY_STRCT  KEY_STRCT;
typedef struct SCAN_RS_STRCT  SCAN_RS_STRCT;
typedef struct CFG_RANGE_SPEC_STRCT  CFG_RANGE_SPEC_STRCT;
typedef struct CFG_RANGE_SPEC_BYTE_STRCT  CFG_RANGE_SPEC_BYTE_STRCT;
...
typedef struct CFG_MB_INFO_FRAG  CFG_MB_INFO_FRAG;
...
typedef struct  CFG_PROG_STRCT;
typedef struct  CFG_FW_PRINTF_STRCT;
typedef struct  CFG_FW_PRINTF_BUFFER_LOCATION_STRCT;
...
typedef struct DUI_STRCT  DUI_STRCT;
typedef DUI_STRCT FAR *	DUIP;
typedef struct CFG_CMD_NIC_STRCT  CFG_CMD_NIC_STRCT;
typedef struct CFG_DRV_INFO_STRCT CFG_DRV_INFO_STRCT;
