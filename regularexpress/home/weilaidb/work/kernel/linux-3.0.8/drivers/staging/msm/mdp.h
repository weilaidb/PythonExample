...
typedef enum  MDP_SCALE_MODE;
typedef enum  MDP_BLOCK_POWER_STATE;
typedef enum  MDP_BLOCK_TYPE;
...
typedef enum  MDP_IBUF_STATE;
struct mdp_dirty_region ;
typedef struct mdp_roi_s  MDP_ROI;
typedef struct mdp_ibuf_s  MDPIBUF;
struct mdp_dma_data ;
