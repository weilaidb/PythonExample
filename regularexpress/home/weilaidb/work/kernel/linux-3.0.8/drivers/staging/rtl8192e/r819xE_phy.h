...
typedef struct _SwChnlCmd  __attribute__ ((packed)) SwChnlCmd;
...
typedef enum _HW90_BLOCK  HW90_BLOCK_E, *PHW90_BLOCK_E;
typedef enum _RF90_RADIO_PATH  RF90_RADIO_PATH_E, *PRF90_RADIO_PATH_E;
