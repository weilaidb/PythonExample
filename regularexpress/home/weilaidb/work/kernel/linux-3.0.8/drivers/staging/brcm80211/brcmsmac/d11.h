...
typedef volatile struct  intctrlregs_t;
typedef volatile struct  pio2regs_t;
typedef volatile struct  pio2regp_t;
typedef volatile struct  pio4regs_t;
typedef volatile struct  pio4regp_t;
typedef volatile union  pmqreg_t;
typedef volatile struct  fifo64_t;
typedef volatile struct _d11regs  d11regs_t;
...
struct ofdm_phy_hdr  __attribute__((packed));
...
struct cck_phy_hdr  __attribute__((packed));
...
struct d11txh  __attribute__((packed));
...
struct tx_status  __attribute__((packed));
...
struct shm_acparams  __attribute__((packed));
...
struct d11rxhdr  __attribute__((packed));
#define	RXHDR_LEN		24
#define	FRAMELEN(h)		((h)->RxFrameSize)
typedef struct wlc_d11rxhdr wlc_d11rxhdr_t;
struct wlc_d11rxhdr  __attribute__((packed));
...
typedef enum  ePsmScratchPadRegDefinitions;
