...
typedef enum _SwChnlCmdIDSwChnlCmdID;
typedef struct _SwChnlCmd__attribute__ ((packed)) SwChnlCmd;
...
typedef enum _HW90_BLOCKHW90_BLOCK_E, *PHW90_BLOCK_E;
typedef enum _RF90_RADIO_PATHRF90_RADIO_PATH_E, *PRF90_RADIO_PATH_E;
