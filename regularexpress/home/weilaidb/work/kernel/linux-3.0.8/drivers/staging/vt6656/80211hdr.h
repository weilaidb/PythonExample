...
typedef struct  IEEE_ADDR, *PIEEE_ADDR;
typedef struct tagWLAN_80211HDR_A2  __attribute__ ((__packed__))
WLAN_80211HDR_A2, *PWLAN_80211HDR_A2;
typedef struct tagWLAN_80211HDR_A3  __attribute__ ((__packed__))
WLAN_80211HDR_A3, *PWLAN_80211HDR_A3;
typedef struct tagWLAN_80211HDR_A4  __attribute__ ((__packed__))
WLAN_80211HDR_A4, *PWLAN_80211HDR_A4;
typedef union tagUWLAN_80211HDR  UWLAN_80211HDR, *PUWLAN_80211HDR;
