...
typedef struct  _ALT_REQP;
typedef struct  _ALT_CONP;
typedef struct  _CON_REQP;
typedef struct  _CON_CONP;
typedef struct  _CON_INDP;
typedef struct  _CON_RESP;
typedef struct  _CON_A_INDP;
typedef struct  _CON_A_RESP;
typedef struct  _DIS_REQP;
typedef struct  _DIS_CONP;
typedef struct  _DIS_INDP;
typedef struct  _DIS_RESP;
typedef struct  _LIS_REQP;
typedef struct  _LIS_CONP;
typedef struct  _INF_REQP;
typedef struct  _INF_CONP;
typedef struct  _INF_INDP;
typedef struct  _INF_RESP;
typedef struct  _SEL_B_REQP;
typedef struct  _SEL_B_CONP;
typedef struct  _FAC_REQP;
typedef struct  _FAC_CON_STRUCTS;
typedef struct  _FAC_CONP;
typedef struct  _FAC_INDP;
typedef struct  _FAC_RESP;
typedef struct  _CON_B3_REQP;
typedef struct  _CON_B3_CONP;
typedef struct  _CON_B3_INDP;
typedef struct  _CON_B3_RESP;
typedef struct  _CON_B3_A_INDP;
typedef struct  _CON_B3_A_RESP;
typedef struct  _DIS_B3_REQP;
typedef struct  _DIS_B3_CONP;
typedef struct  _DIS_B3_INDP;
typedef struct  _DIS_B3_RESP;
typedef struct  _DAT_B3_REQP;
typedef struct  _DAT_B3_REQ64P;
typedef struct  _DAT_B3_CONP;
typedef struct  _DAT_B3_INDP;
typedef struct  _DAT_B3_IND64P;
typedef struct  _DAT_B3_RESP;
typedef struct  _RES_B3_REQP;
typedef struct  _RES_B3_CONP;
typedef struct  _RES_B3_INDP;
typedef struct  _RES_B3_RESP;
typedef struct  _CON_B3_T90_A_INDP;
typedef struct  _CON_B3_T90_A_RESP;
