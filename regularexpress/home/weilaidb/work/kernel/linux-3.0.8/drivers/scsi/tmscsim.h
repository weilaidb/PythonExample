...
#define SET_RES_TARGET(who, tgt) do  while (0)
#define SET_RES_TARGET_LNX(who, tgt) do  while (0)
#define SET_RES_MSG(who, msg) do  while (0)
#define SET_RES_DID(who, did) do  while (0)
#define SET_RES_DRV(who, drv) do  while (0)
...
typedef struct  dc390_cmd_scp_t;
