...
#define bfa_reqq_produce(__bfa, __reqq)	do  while (0)
#define bfa_rspq_pi(__bfa, __rspq)					\
(*(u32 *)((__bfa)->iocfc.rsp_cq_shadow_pi[__rspq].kva))
#define bfa_rspq_ci(__bfa, __rspq)	((__bfa)->iocfc.rsp_cq_ci[__rspq])
#define bfa_rspq_elem(__bfa, __rspq, __ci)				\
(&((struct bfi_msg_s *)((__bfa)->iocfc.rsp_cq_ba[__rspq].kva))[__ci])
#define CQ_INCR(__index, __size) do  while (0)
...
#define bfa_reqq_wait(__bfa, __reqq, __wqe) do  while (0)
#define bfa_reqq_wcancel(__wqe)	list_del(&(__wqe)->qe)
struct bfa_cb_qe_s ;
#define bfa_cb_queue(__bfa, __hcb_qe, __cbfn, __cbarg) do  while (0)
#define bfa_cb_dequeue(__hcb_qe)	list_del(&(__hcb_qe)->qe)
#define bfa_cb_queue_once(__bfa, __hcb_qe, __cbfn, __cbarg) do  while (0)
#define bfa_cb_queue_done(__hcb_qe) do  while (0)
struct bfa_pciid_s ;
