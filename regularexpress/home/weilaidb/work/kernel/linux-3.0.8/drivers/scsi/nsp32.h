...
typedef struct _nsp32_sgtable  __attribute__ ((packed)) nsp32_sgtable;
typedef struct _nsp32_sglun  __attribute__ ((packed)) nsp32_sglun;
#define NSP32_SG_TABLE_SIZE (sizeof(nsp32_sgtable) * NSP32_SG_SIZE * MAX_TARGET * MAX_LUN)
typedef struct _nsp32_autoparam  __attribute__ ((packed)) nsp32_autoparam;
