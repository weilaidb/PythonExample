...
%build
%ifos linux
CFLAGS="$RPM_OPT_FLAGS" ./configure --prefix=% --disable-video-directfb
%else
%configure
%endif
make
...
bindir=$RPM_BUILD_ROOT% \
libdir=$RPM_BUILD_ROOT% \
includedir=$RPM_BUILD_ROOT% \
datadir=$RPM_BUILD_ROOT% \
mandir=$RPM_BUILD_ROOT%
%else
%makeinstall
%endif
%clean
